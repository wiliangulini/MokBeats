...
const routes: Routes = [
  ...
  { path: 'artista', component: ArtistComponent, canActivate: [AuthGuard, ProdutorGuard] },
  ...
  { path: 'upload', loadChildren: () => import('./upload-file/upload-file.module').then(m => m.UploadFileModule), canActivate: [AuthGuard, ProdutorGuard, ProfileCompleteGuard] },
